...
{
/*
	public static final EnumProperty<EnumFacing.Axis> AXIS = PropertyEnum.create("axis", EnumFacing.Axis.class, EnumFacing.Axis.X, EnumFacing.Axis.Z);
	...
	{
		super(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(Float.MAX_VALUE).sound(SoundType.METAL));
